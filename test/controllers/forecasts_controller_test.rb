...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post forecasts_url, params: { forecast: { game_id: @forecast.game_id, selection: @forecast.selection } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { game_id: @forecast.game_id, selection: @forecast.selection } }
